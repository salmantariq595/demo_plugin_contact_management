...
@php
    $path = url("/Modules/ShopifySync/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Streamline your operations and enhance customer experiences by simplifying the management of Shopify products, categories, customers, orders and coupons. Our integration solutions empower you to take your online sales to the next level.')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Simplify ')}}<b>{{__('Shopify')}}</b>{{__(' Integration')}}</h2>
                <p>{{__('Supercharge your online sales with Shopify integration by simplifying Shopify product, category, customer, order and coupon management.
                    ')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Effortless Product Management and Seamless Coupon Control')}}</h2>
                        </div>
                        <p>{{__('Simplify your Shopify store operations with user-friendly tools designed to streamline product and inventory management. Spend less time on administrative tasks and more time focusing on business growth. Take control of your discount strategy with our intuitive coupon management system.')}}</p>
                    </div>
                </div>
